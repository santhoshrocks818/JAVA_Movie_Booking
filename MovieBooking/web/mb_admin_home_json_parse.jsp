           ...
           String[] language=null;
             ...
             <script>
                    function direct(name,lang) {
                     ...
                     <p id="demo"></p>
                     <button onclick='/mb_Movie_info?"<%=name%>"&"<%=str%>"'                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  class="btn btn-info pull-right">>Book</button>

                  <%--   <button onclick='direct("<%=name%>","<%=str%>")'  class="btn btn-info pull-right">>Book</button>
